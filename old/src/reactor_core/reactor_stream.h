...
#define REACTOR_STREAM_BUFFER_SIZE 131072
#endif

enum REACTOR_STREAM_EVENTS
{
  REACTOR_STREAM_ERROR           = 0x01,
  REACTOR_STREAM_CONNECT         = 0x02,
  REACTOR_STREAM_DATA            = 0x04,
  REACTOR_STREAM_WRITE_BUSY      = 0x08,
  REACTOR_STREAM_WRITE_AVAILABLE = 0x10,
  REACTOR_STREAM_END             = 0x20,
  REACTOR_STREAM_CLOSE           = 0x40
};
...
enum REACTOR_STREAM_FLAGS
{
  ...
  REACTOR_STREAM_ESTABLISHED     = 0x02,
  REACTOR_STREAM_WRITE_AGAIN     = 0x04
};
